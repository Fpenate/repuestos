...
public class Cls_Productos {
    ...
    private DefaultTableModel setTitulosProductos(){
        ...
        DT.addColumn("Código");
        DT.addColumn("Descripción del Repuesto");
        return DT;
    }
    ...
    public int registrarProducto(String codigo, String descripcion){
        ...
        try {
            ...
            if(res > 0){
                JOptionPane.showMessageDialog(null, "Repuesto registrado con éxito.");
            }
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "No se pudo registrar el Repuesto");
