...
public class Frm_Productos extends javax.swing.JInternalFrame {
    ...
    private void guardar() {
        ...
        if (codigo.equals("") || descripcion.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "Por favor no dejar campos Vacíos", "Error!", JOptionPane.ERROR_MESSAGE);
            limpiar();
        } else {
            if (num == 0) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Código del Repuesto *");
        ...
        jLabel2.setText("Registro de Repuestos");

        jLabel3.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel3.setText("Llene la información respectiva de los repuestos.");
